...
const Footer = ({ darkMode }) => {
    return (
        <footer className={`${darkMode ? 'bg-dark text-light' : 'bg-light text-dark'} text-center p-3`}>
            <p>
                <a href="https://www.linkedin.com/in/rory-van-blaricom/" target="_blank" rel="noopener noreferrer" className="m-3">
                    <img src={linkedInLogo} alt="LinkedIn Logo" style={{width: 'auto', height: '30px'}} />
                </a> | 
                <a href="https://github.com/RoryV91" target="_blank" rel="noopener noreferrer" className="m-3">
                    <img src={darkMode ? githubWhite : githubBlack} alt="GitHub Logo" style={{width: 'auto', height: '30px'}} />
                </a> | 
                <a href="https://twitter.com/R0ry_V" target="_blank" rel="noopener noreferrer" className="m-3">
